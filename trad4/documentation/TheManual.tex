...
\title{The Manual \\
{\large \textbf{trad4 version 4.0}}}

\author{Steve Evans \\\\ Steve has a B.Sc. in Anthropology \\ and an M.Sc. in Computer Science, both from UCL. \\ He has twelve years of experience developing and supporting \\ front office trading and risk systems. He lives in London.}

\date{Document version 4.0 \\
\today}
...
The next four sections are supposed to be read alongside a downloaded, build-able, run-able copy of the source - the trad4_v4_0_full distribution contains all applications referred to in this document.
