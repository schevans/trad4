...
T4_3RD_PARTY_LIBS contains the space-separated full paths to any third-party libraries you're using, e.g. (from vision_thing) "$APP_ROOT/lib/3rd_party/libjpeg.so $APP_ROOT/lib/3rd_party/libgd.so"
